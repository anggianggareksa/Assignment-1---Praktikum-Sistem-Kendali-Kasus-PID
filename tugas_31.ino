...
//Nama Tim : SoloRank
//Nama Anggota 1 : Anggi Angga Reksa
//Versi Program : 1.0
...
int Last_Error = 0;
int error = 0;
int mtrSPDright, mtrSPDleft, setPointSPD = 150, PID_movement; 
...
//  Serial.print ("\n");
  ...
  int kp = 10, ki = 0, kd = 0; // kp range = 1 - 5
  int rate = error - Last_Error; // 0 - (-2) = 2
  PID_movement = (kp*Last_Error);
  mtrSPDright = setPointSPD + PID_movement; // 150 - 30 = 120
  mtrSPDleft = setPointSPD - PID_movement; // 150 + 30 = 180
